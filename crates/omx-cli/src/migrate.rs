...
fn parse_rollout_files(sessions_dir: &Path) -> Result<(usize, Vec<ParsedSession>), String> {
...
fn write_rust_session(sessions_root: &Path, session: &ParsedSession) -> Result<(), String> {
